...
const skillSections = [
  ...
  {
    label: "Databases",
    items: ["PostgreSQL", "MongoDB", "SQL", "Firebase", "MongoDB Indexing"],
  },
  {
    label: "Infra & Tools",
    items: ["Docker", "Git", "GitHub Actions", "Railway", "Vercel", "Render"],
  },
  {
    label: "CS Fundamentals",
    items: ["Data Structures & Algorithms", "System Design", "OOP", "Operating Systems", "DBMS", "Computer Networks"],
  },
];
    ...
    <section className="skills-section" id="skills" ref={ref}>
      <div className="skills-inner">
        ...
        <h2 className="section-title">
          Skills &amp; <span className="title-dim">Tools</span>
        </h2>
